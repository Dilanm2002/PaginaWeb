'use strict';
/**
 * vista.js — Módulo de renderizado de la sección de contacto.
...
window.ModuloVista = (function () {
   ...
   */
  const renderContacto = containerId => {
