'use strict';
/**
 * app.js — Módulo coordinador de la aplicación.
 *
 * Responsabilidades:
 ...
 *  - Coordinar la inicialización de RepoModule, CartIDB y ViewModule.
 *
 ...
 *   (localStorage e IndexedDB son gestionados por el script principal y CartIDB)
 */
window.AppModule = (function () {
  ...
  function getCookie(name) {
    ...
    var match = document.cookie.match(new RegExp('(?:^|; )' + enc + '=([^;]*)'));
   ...
   */
  function guardarFiltroSesion(cat) {
    try {
  ...
  return {
    ...
    guardarFiltroSesion: guardarFiltroSesion,
    getFiltroSesion    : getFiltroSesion
  };
})();
