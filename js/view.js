...
window.ViewModule = (function () {
  ...
  function renderContacto(containerId) {
    ...
    el.innerHTML = [
      ...
      '    <p class="contacto-desc">¿Tienes sugerencias, reservas o comentarios? Escríbenos y te responderemos a la brevedad.</p>',
      ...
      '        <textarea id="cf-msg" name="mensaje" rows="4" maxlength="500"',
